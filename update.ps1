...
# ==================================================================
$appService = "app"
$siemWorkerServices = @("syslog-receiver", "siem-parser", "siem-rules", "siem-alerts", "siem-ai", "siem-retention", "siem-snapshot", "incidents-overdue-notify", "backup-scheduler", "network-doc-sync")
